...
<div id="ieee-tinkherhack" style="margin-bottom: 50px;">
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; align-items: end;">
    <img src="{{ site.baseurl }}/images/tink-her-hack-group.png" alt="Group" style="border-radius: 8px; width: 100%; height: auto; border: 1px solid #eee;">
    <img src="{{ site.baseurl }}/images/tink-her-hack-ceremony.png" alt="Ceremony" style="border-radius: 8px; width: 100%; height: auto; border: 1px solid #eee;">
  </div>
...
<div id="ieee-iedc" style="margin-bottom: 50px; margin-top: 50px;">
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; align-items: end;">
    <img src="{{ site.baseurl }}/images/iedc-summit-group.jpeg" alt="PEC Team" style="border-radius: 8px; width: 100%; height: auto; border: 1px solid #eee;">
    <img src="{{ site.baseurl }}/images/iedc-summit-kit.jpeg" alt="Kit" style="border-radius: 8px; width: 100%; height: auto; border: 1px solid #eee;">
  </div>
  <p style="font-size: 0.9em; color: #666; margin-top: 10px;"><em>Representing PEC at one of Kerala's largest entrepreneurial summits.</em></p>
</div>
...
<div id="nss-nrpf" style="margin-bottom: 50px; margin-top: 50px;">
  ...
  <p>Documentation of participation as Unit Coordinator (UC) at ACE College of Engineering.
...
<div id="aapda-mitra" style="margin-top: 50px;">
  <h2>Aapda Mitra Training</h2>
  <p>Evidence from the 7-day intensive disaster management camp.
  ...
  <p><em>[Training photos and Certificate placeholder]</em></p>
</div>
